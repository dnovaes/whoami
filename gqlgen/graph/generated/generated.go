...
type ComplexityRoot struct {
	...
	Experience struct {
		...
		CompanyLink func(childComplexity int) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Experience.companyLink":
		if e.complexity.Experience.CompanyLink == nil {
			break
		}

		return e.complexity.Experience.CompanyLink(childComplexity), true
	...
	case "Experience.finishedAt":
		if e.complexity.Experience.FinishedAt == nil {
			break
		}

		return e.complexity.Experience.FinishedAt(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `# GraphQL portfolio schema
#
...
func (ec *executionContext) _Experience_companyLink(ctx context.Context, field graphql.CollectedField, obj *model.Experience) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Experience_finishedAt(ctx context.Context, field graphql.CollectedField, obj *model.Experience) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_createExperience(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateExperience(rctx, args["input"].(model.NewExperience))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewExperience(ctx context.Context, obj interface{}) (model.NewExperience, error) {
	...
	for k, v := range asMap {
		...
		case "companyLink":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("companyLink"))
			it.CompanyLink, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "startedAt":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("startedAt"))
			it.StartedAt, err = ec.unmarshalOTimestamp2ᚖtimeᚐTime(ctx, v)
			if err != nil {
				return it, err
			}
		case "finishedAt":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("finishedAt"))
			it.FinishedAt, err = ec.unmarshalOTimestamp2ᚖtimeᚐTime(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) _Experience(ctx context.Context, sel ast.SelectionSet, obj *model.Experience) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "year":
			out.Values[i] = ec._Experience_year(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "company":
		...
		case "companyLink":
			out.Values[i] = ec._Experience_companyLink(ctx, field, obj)
		case "startedAt":
			out.Values[i] = ec._Experience_startedAt(ctx, field, obj)
		case "finishedAt":
			out.Values[i] = ec._Experience_finishedAt(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
